...
Усыхание дендрита до нуля надо проработать отдельно.
*/
...
func (d *Dendrite) ReactionSignal(weigth int64) {
	d.health += weigth // отрицательная реакция (мы не угадали) снижает здоровье. Это может быть полезно для "усыхания" связи.
